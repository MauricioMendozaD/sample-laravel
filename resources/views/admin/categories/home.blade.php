    ...
    <div class="row">
        <div class="col-md-3">
            <div class="panel shadow">
                <div class="header">
                    <h2 class="title">
                        <i class="fas fa-folder"></i> Agregar Categoria
                    </h2>
                </div>
                        ...
                        <tbody>
                            @foreach($cats as $cat)
                                <tr>
                                    ...
                                    <td>
                                        <div class="opts">
                                            <a href="{{ url('/admin/categories/'.$cat->id.'/edit') }}" data-toggle="tooltip" data-placement="top" title="Editar">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{ url('/admin/categories/'.$cat->id.'/delete') }}" data-toggle="tooltip" data-placement="top" title="Eliminar">
